    ...
    <>
      <div className="w-full md:flex hidden justify-between shadow items-center py-3 lg:px-16 md:px-12 sm:px-8 px-2">
        <Link to="/" className="flex items-center">
          <h1 className="font-bold text-xl font-mono">Tiffin Town</h1>
        </Link>
        <ul className="gap-4 flex items-center font-semibold ">
          ...
          {name ? (
            ...
            <div className="flex items-center gap-2">
              <li className="border border-slate-900 text-slate-900 px-2 py-1">
                <Link to="/signin">Login</Link>
              </li>
              <li className="bg-slate-800 text-white px-2 py-1">
...
function NavbarSm({ name }) {
  ...
  return (
    <>
      ...
      <ul
        className={`gap-3 flex flex-col items-center absolute z-10 font-semibold h-64 transition ease-in-out duration-500  py-3 w-full ${
